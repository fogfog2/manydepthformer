...
class PatchAggregation(t.nn.Module):
    ...
    def __init__(self, in_channels = 16, out_channels = 46, kernel_size = 2, stride = 2 , padding = 0):
        """
        Args :
...
class LMHSA(t.nn.Module):
    ...
    def __init__(self, input_width, input_height, kernel_size, d_k, d_v, num_heads, in_channels = 46):
        """
        Args :
            --input_size
        ...
        self.B = t.nn.Parameter(t.rand(1, num_heads, input_width * input_height, (input_width // kernel_size) *(input_height // kernel_size)), requires_grad = True)
...
class CMTBlock(t.nn.Module):
    ...
    def __init__(self, input_width, input_height, kernel_size, d_k, d_v, num_heads, R = 3.6, in_channels = 46):
        """
        Args :
            --input_size
            --kernel_size: for DWConv
        ...
        # 2. LMHSA
        self.lmhsa = LMHSA(input_width = input_width,
